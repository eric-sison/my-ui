...
export const modalWidthStyles = (size: string | undefined) => {
  return cx({
    'w-full max-w-md transform overflow-hidden rounded-lg bg-white p-6 text-left align-middle shadow-xl transition-all': true,
    'max-w-[35%]': size === 'sm',
    'max-w-[45%]': size === 'md',
    'max-w-[60%]': size === 'lg',
    'max-w-[80%]': size === 'xl',
...
export const modalFooterStyles = (alignEnd: boolean | undefined) => {
  return cx({
    'flex items-center gap-2 text-gray-200': true,
